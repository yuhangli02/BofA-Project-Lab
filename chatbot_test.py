...
def is_finance_related(question):
    ...
    The function includes all terms from the database schema, relevant synonyms, and acronyms.

    Args:
        question (str): The user's input question.

    Returns:
        bool: True if the question is finance-related, otherwise False.
    """
    finance_keywords = {
        ...
        'tot_debt_tot_equity', 'mkt_val', 'shares_out', 'sector',

        # Synonyms and acronyms
        'earnings', 'profit', 'loss', 'liabilities', 'assets', 'cash flow', 'balance sheet', 
        'income statement', 'revenue', 'expenses', 'long-term debt', 'lt debt', 'ROI', 'P/E', 
        'price to earnings', 'D/E', 'debt to equity', 'return on equity', 'ROE', 'ROA', 
        'return on assets', 'NASDAQ', 'NYSE', 'financial ratios'
    }

    # Check if any finance-related keyword is in the question
